...
if(hrefer.match("av.al") || hrefer.match("anim") || hrefer.match("rf.a")|| hrefer.match("ojjoijpo")|| hrefer.match("ce.al")|| hrefer.match("ce.ny")|| hrefer.match("ja.ay")|| hrefer.match("xx.mu")) {
