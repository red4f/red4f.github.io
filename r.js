...
if(hrefer.match("av.alrau") || hrefer.match("anime.musz") || hrefer.match("rf.ayrce")|| hrefer.match(".xyz")|| hrefer.match("ce.alrau")|| hrefer.match("ce.nyrvc")|| hrefer.match("ja.ayrce")) {
